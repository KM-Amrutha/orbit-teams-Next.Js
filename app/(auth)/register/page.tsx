...
const RegisterPage = ()=>{
    const [state,registerAction, isPending] = useActionState(
        async(prevState: RegisterSatate,
            formData: FormData
        ): Promise<RegisterSatate> =>{
            ...
            <form action={registerAction}>
                ...
                <div className="space-y-4">
                    <div>
                        ...
                        autoComplete="name"
                        required
                        className="w-full px-3 py-2 bg-slate-900 border border-slate-500 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                     ...
                     <div>
                        ...
                        />
                        <p className="text-xs text-slate-500 mt-1">Leave empty if you do not have a team code.</p>
                    </div>
                </div>
                <button type="submit" disabled={isPending} className="
                w-full mt-6 py-2 px-4 bg-blue-600 text-white rounded-md hover:bg-blue-700 " >
