  ...
  return (
    ...
    <div className='bg-slate-800 p-6 border border-slate-700'>  
     ...
     <ul className=' space-y-1 text-sm text-slate-300'>
        ...
        <li><strong className='text-purple-400'> Super Admin:</strong> Full System Access
        </li>
        <li><strong className='text-green-400'>Admin:</strong> User & Team management
        </li>
        <li><strong className='text-yellow-400'>Manager:</strong> Team specific management
        </li>
        <li><strong className='text-blue-400'>User :</strong> Basic Dashboard
        </li>
        </ul>
        </div>
    </div>
    {user ? ( <div className=' bg-green-900/30 border border-green-600 rounded-lg p-4'> 
     <p className='text-green-300'>
      Welcome back,<strong>Amrutha</strong>! You are logged in as{" "}
       <strong className='text-green-200'>USER</strong>
         ...
         <div className='bg-blue-900/30 border border-blue-600 rounded-lg p-4'>
           ...
           >
            ...
            <Link
           href='/register'
           className='px-4 py-2 border border-slate-600 text-slate-300 rounded hover:bg-blue-700 transition-colors '
           >
            Register</Link>
         </div>
         </div>
